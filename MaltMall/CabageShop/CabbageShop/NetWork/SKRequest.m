...
-(void) tokenIsError:(NSInteger)code andMessage:(NSString *)message {
    ...
    switch (code) {
        case 4002:
        {
            if ([[UIApplication sharedApplication].keyWindow.rootViewController isKindOfClass:[JGLoginViewController class]]) {
                return;
            }else{
                JGLoginViewController * presentVc1 = [[JGLoginViewController alloc] init];
