...
//    JPUSHService.deleteAlias(nil, seq: 2)
    ...
    return LNNavigationController.init(rootViewController: JGLoginViewController())
}
...
//MARK:***********************微信支付************************
//MARK:***********************微信支付************************
let kWXAppKey = "wx37f2673fafb4c0cb"
let kWXAppSecret = "d6209651c660ddbb764c33d3b61867bd"
