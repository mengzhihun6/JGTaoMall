//
//  JGRegisterViewController.swift
//  CabbageShop
//
...
class JGRegisterViewController: LNBaseViewController {
    ...
    func configUI() {
        ...
        LoginBtn.snp.makeConstraints { (make) in
            ...
            make.right.equalTo(RegisterBtn.snp_right)
        }
    }
...
//            }
    ...
    @objc func LoginBtnClick() {
        ...
        for vc in (self.navigationController!.viewControllers) {
            ...
            if vc.isKind(of: JGLoginViewController.self) == true {
