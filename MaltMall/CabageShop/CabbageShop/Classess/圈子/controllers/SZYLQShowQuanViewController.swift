...
//        UIApplication.shared.statusBarStyle = .default
    ...
    private lazy var layout: LTLayout = {
        ...
        layout.titleColor = UIColor(r: 255, g: 255, b: 255) // 标题颜色值(格式不能改) 没选中的
        layout.titleSelectColor = UIColor(r: 0, g: 0, b: 0) //选中标题颜色值
        layout.titleFont = UIFont.font(16) //
        layout.sliderHeight = 50.0  //整个滑块的高
        layout.bottomLineColor = UIColor.clear
        layout.bottomLineHeight = 0.0
        layout.normalBgColor = UIColor.hex("#000000")
        layout.selectedBgColor = UIColor.hex("#F3D6B5")
        layout.subToTop = 10.0
        layout.titleMargin = 0.0
