...
//        [self insertSubview:self.contentView atIndex:0];
        self.insertSubview(self.contentView, at: 0)
        // Initialization code
...
//        lijitixianBun.backgroundColor = kSetRGBColor(r: 239, g: 6, b: 93)
        ...
        yanzhengmaTextField.isUserInteractionEnabled = true
        yanzhengmaBun.isUserInteractionEnabled = true
        tixianjineTextField.isUserInteractionEnabled = true
        quanbutixianBun.isUserInteractionEnabled = true
