...
//        navigationBgImage = UIImage.init(named: "Rectangle") 
    ...
    override func configSubViews() {
        ...
        let textField = UITextField.init(frame: CGRect.init(x: 10, y: navHeight + 10, width: kSCREEN_WIDTH - 20, height: 35))
        textField.backgroundColor = UIColor.white
        textField.clipsToBounds = true
        textField.delegate = self
        textField.textAlignment = NSTextAlignment.center
        textField.returnKeyType = .search
        textField.backgroundColor = UIColor.init(r: 247, g: 247, b: 247)
        textField.cornerRadius = textField.height / 2.0
        textField.placeholder = "输入你正在找的宝贝"
