...
//        imageView.image = UIImage.init(named: "Rectangle")
        ...
        title.snp.makeConstraints { (make) in
            make.centerY.equalTo(backBtnCenterY);
...
//        }
        ...
        numLabel = UILabel.init(frame: CGRect.init(x: 10, y: kSCREEN_HEIGHT - 60, width: kSCREEN_WIDTH - 20, height: 50))
        ...
        mainTableView = getTableView(frame: CGRect(x: 0, y: viewHeight , width: kSCREEN_WIDTH, height: kSCREEN_HEIGHT-viewHeight - 60), style: .plain, vc: self)
        mainTableView.register(UINib(nibName: "LNShowMyTeamCell", bundle: nil), forCellReuseIdentifier: identyfierTable)
        self.automaticallyAdjustsScrollViewInsets = false
        
        let headerView = UIView.init(frame: CGRect(x: 0, y:0, width: kSCREEN_WIDTH, height: 174))
//        headerView.backgroundColor = UIColor.red;
        searchTextfield.borderStyle = .none
        searchTextfield.backgroundColor = UIColor.init(r: 247, g: 247, b: 247)
        searchTextfield.frame = CGRect(x: 10, y: 15, width: kSCREEN_WIDTH - 20, height: 35)
        ...
        let headerImage = UIImageView.init(frame: CGRect(x: 0, y: 64, width: kSCREEN_WIDTH, height: 110))
        headerImage.image = UIImage.init(named: "jg_my_share")
...
//        }
    ...
    func addImageWhenEmpty() {
        ...
        emptyView = UIView.init(frame: CGRect(x: 0, y: 174, width: kSCREEN_WIDTH, height: kSCREEN_HEIGHT - 46))
