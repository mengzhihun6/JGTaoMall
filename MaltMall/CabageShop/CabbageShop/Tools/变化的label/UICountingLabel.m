...
-(void)countFrom:(CGFloat)value to:(NSString *)endValue {
    
    if (self.animationDuration == 0.0f) {
        self.animationDuration = 2.0f;
    }
    
    [self countFrom:value to:[endValue floatValue] withDuration:self.animationDuration];
}
