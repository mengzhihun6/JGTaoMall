...
//        }
        ...
        setKeyBoard()
        BaiduMobStat.default().start(withAppId: "388555ad06")
...
//            let arr1 = isJudgeCharNumber(str: text!, char: "€")
//            let arr2 = isJudgeCharNumber(str: text!, char: "《")
//            let arr3 = isJudgeCharNumber(str: text!, char: "¥")
//            let arr4 = isJudgeCharNumber(str: text!, char: "$")
//            let arr5 = isJudgeCharNumber(str: text!, char: "₰")
//            let arr6 = isJudgeCharNumber(str: text!, char: "₴")
//            let arr7 = isJudgeCharNumber(str: text!, char: "¢")
//            let arr8 = isJudgeCharNumber(str: text!, char: "￥")
//
//            if arr1 == 2 || arr2 == 2 || arr3 == 2 || arr4 == 2 || arr5 == 2 || arr6 == 2 || arr7 == 2 || arr8 == 2 || ((text?.contains("("))! && (text?.contains(")"))!) {
//
//            } else {
//                // 跳搜索页面
//                if (text?.lengthOfBytes(using: .utf8))! > 120 {
//                    return
//                }
//                let tabbar = self.window?.rootViewController as? LNMainTabBarController
//                let nav = tabbar?.childViewControllers[(tabbar?.selectedIndex)!] as? LNNavigationController
//
//                let vc = BCTPasteSearchViewController()
//                vc.Delegate = self
//                vc.neirong = text!
...
//        kDeBugPrint(item: " 判断传入数据  输出结果 \(str) \(char)")
        ...
        for index in str.indices.indices {
            let sss: String = String(format: "\(str[index])") as! String
