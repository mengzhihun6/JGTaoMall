...
//    没用到
    ...
    func setUpUserInfo(GoodsInformationModel:SZYGoodsInformationModel, StoreInformationModel:SZYStoreInformationModel) {
        ...
        quanEBun.setTitle("  " + OCTools().getStrWithIntStr(GoodsInformationModel.coupon_price) + "元券  ", for: .normal)
...
//        店铺信息
    ...
    public var model : LNYHQDetailModel = LNYHQDetailModel() {
        didSet {
            ...
            quanEBun.setTitle("  " + OCTools().getStrWithIntStr(model.coupon_price) + "元券  ", for: .normal)
