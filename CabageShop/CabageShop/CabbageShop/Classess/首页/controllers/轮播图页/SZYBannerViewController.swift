//
//  SZYBannerViewController.swift
//  CabbageShop
//
//  Created by 宋宗宇 on 2019/3/5.
...
class SZYBannerViewController: LNBaseViewController {
...
//        request.callGET(withUrl: LNUrls().kSwhow_coupon) { (response) in
        ...
        request.setParam("2" as NSObject, forKey: "searchtype")
        request.setParam(SZYTypeString as NSObject, forKey: "q")
        request.setParam(String(currentPage) as NSObject, forKey: "page")
        request.setParam("1" as NSObject, forKey: "sort")
...
//tableView代理
extension SZYBannerViewController : UITableViewDataSource, UITableViewDelegate {
