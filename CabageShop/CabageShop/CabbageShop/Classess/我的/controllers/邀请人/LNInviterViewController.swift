...
//            UserDefaults.standard.synchronize()
    ...
    func createClick() {
        ...
        for index in 0..<array.count {
            ...
            let x = 15 + (viewWidth + 15) * CGFloat(index), height = viewWidth * 667 / 375
            
            let bg_bg_View = UIView.init(frame: CGRect.init(x: x, y: (scrollView.height - height) / 2, width: viewWidth, height: height))
            ...
            let codeImageView = UIImageView.init(frame: CGRect.init(x: 135 * viewWidth / 375, y: 500 * height / 667, width: 105 * viewWidth / 375, height: 105 * viewWidth / 375))
            ...
            inviteiCodeLab.text = inviteCodeStr
        ...
        scrollView.contentSize = CGSize(width: (kSCREEN_WIDTH * 2 / 3 + 15) * CGFloat(array.count) + 15, height: scrollView.height)
