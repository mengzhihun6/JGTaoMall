...
//        imageView.image = UIImage.init(named: "collect_empty_icon")
    ...
    override func configSubViews() {
        ...
        navigationView.backgroundColor = kSetRGBColor(r: 233, g: 13, b: 68)
        self.view.addSubview(navigationView)
        let imageView = UIImageView.init(frame: CGRect(x: 0, y: 0, width: kSCREEN_WIDTH, height: navHeight))
//        imageView.image = UIImage.init(named: "Rectangle")
        ...
        attrString.addAttributes([NSAttributedStringKey.foregroundColor: kGaryColor(num: 96)], range: NSMakeRange(0, "输入关键词查券".count))
...
//        navigationView.addSubview(searchTextfield)
        ...
        let view = UIView.init(frame: CGRect(x: 0, y: 0, width: 100, height: 34))
        view.backgroundColor = UIColor.clear
        searchBun = UIButton.init(type: .custom)
        searchBun.frame = CGRect.init(x: 0, y: 0, width: 80, height: 34)
        searchBun.setTitle(titles[Int(type)! - 1], for: .normal)
        searchBun.setImage(UIImage.init(named: "com_arrow_bottom"), for: .normal)
        searchBun.titleLabel?.font = UIFont.systemFont(ofSize: 13)
        searchBun.setTitleColor(kSetRGBColor(r: 30, g: 30, b: 30), for: .normal)
        ...
        view.addSubview(searchBun)
        let leftImage = UIImageView.init(frame: CGRect(x: 80, y: 10, width: 14, height: 14))
        ...
        topView = LNTopScrollView2.init(frame: CGRect(x: 0, y: CGFloat(navHeight), width: kSCREEN_WIDTH, height: 40))
        ...
        let selectView = UIView.init(frame: CGRect(x: 0, y: navHeight+40, width: kSCREEN_WIDTH, height: 37))
        ...
        markButton.setTitleColor(kGaryColor(num: 96), for: .normal)
...
//            detailVc.isSuper_VIP = true
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        if !isCollect {
            return CGSize(width: kSCREEN_WIDTH, height: 120)
        }else{
